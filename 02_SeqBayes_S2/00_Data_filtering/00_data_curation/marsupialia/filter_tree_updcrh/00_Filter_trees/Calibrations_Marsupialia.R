...
#=================#
# Get trees 
tree_original <- readLines( con = "marsupialia_rooted_calibnames.tree" )
tree <- tree_original

# Get sp names 
spnames <- ape::read.tree( "marsupialia_rooted_calibnames.tree" )$tip.label

#======================================#
#    3. GET FILE WITH CALIBRATIONS 
#======================================#
# Read tree and rename cols
calibrations <- read.table( file = "Calibrations_Marsupialia.txt",
...
num_sp <- length( ape::read.tree( "marsupialia_rooted_calibnames.tree" )$tip.label )
...
# Generate dummy aln
if( ! dir.exists( "../../../../01_alignments/01_mammal_dummy_alns/" ) ){
  dir.create( "../../../../01_alignments//01_mammal_dummy_alns/" )
}
if( ! dir.exists( paste( "../../../../01_alignments/01_mammal_dummy_alns/",
                         tolower( tname ), sep = "" ) ) ){
  dir.create( paste( "../../../../01_alignments/01_mammal_dummy_alns/",
                     tolower( tname ), sep = "" ) )
}
write( x = phylip_header_aln, file = paste( "../../../../01_alignments/01_mammal_dummy_alns/", 
                                            tolower( tname ), "/dummy_aln.aln", sep = "" ) )
write( x = spnames.2nuc, file = paste( "../../../../01_alignments/01_mammal_dummy_alns/", 

...
wd3 <- gsub( pattern = "01_Check_conflict_v2", replacement = "01_Check_conflict", x = wd )
...
ST.dists <- define_ST( log_ST = paste( wd3, "00_Prior_onlyST/log.mammals.mcmc1.txt", sep = "" ),
...
onlyST <- load_data( mcmc1 = paste( wd3, "00_Prior_onlyST/mcmc1/mcmc.txt", sep = "" ),
                     mcmc2 = paste( wd3, "00_Prior_onlyST/mcmc2/mcmc.txt", sep = "" ) )
...
text( x = 100, y = 175,
      labels = expression( atop( ''*italic( w )*' = '*italic( 0.998892 * t )*'' ) ) )
...
text( x = 100, y = 145,
      labels = expression( atop( ''*italic( w )*' = '*italic(  1.003752 * t )*'' ) ) )
...
text( x = 110, y = 200,
      labels = expression( atop( ''*italic( R^2 )*' = 0.9997' ) ) )
text( x = 110, y = 195,
      labels = expression( atop( ''*italic( w )*' = '*italic(  1.038844 * t )*'' ) ) )
...
#
# A) E.g., 2.5% (mean deviation) of 50.00415 (My, x.mean) --> 1.250104
#    Let's subtract that deviation from x_i (ST.calibs[[ 4 ]]) after dividing into 100
#       0.507 - 0.01250104 = 0.1404415
#===================================================================================================#
...
#
# A) E.g., -51.6% (mean deviation) of 0.008513931 (sd) --> -0.004393188
#    Let's subtract that deviation from w_i (ST.calibs[[ 5 ]][2])
#       0.0092 - (-0.004393188) = 0.01359319
dub.pos              <- c( 4, 5, 6 ) 
...
text( x = 100, y = 175,
      labels = expression( atop( ''*italic( w )*' = '*italic( 0.996907 * t )*'' ) ) )
...
text( x = 100, y = 150,
      labels = expression( atop( ''*italic( R^2 )*' = 0.9997' ) ) )
text( x = 100, y = 145,
      labels = expression( atop( ''*italic( w )*' = '*italic(  1.001988 * t )*'' ) ) )
...
text( x = 110, y = 200,
      labels = expression( atop( ''*italic( R^2 )*' = 0.9997' ) ) )
text( x = 110, y = 195,
      labels = expression( atop( ''*italic( w )*' = '*italic(  1.043982 * t )*'' ) ) )
...
#
# A) E.g., 3.0% (mean deviation) of 50.00415 (My, x.mean) --> 1.500125
#    Let's subtract that deviation from x_i (ST.calibs.tweak[[ 4 ]])after dividing into 100
#       0.49449896 - 0.01500125 = 0.4794977
#===================================================================================================#
# Values to add to ST for next tweaking (scale ~ sd)
#   100                            ---> sd_est_divt.post72sp[ind.post.72sp[dub.pos.2]]
#   sum.stats.ord.2[dub.pos.2,5]  ---> add.to.STwi = ?
#
# A) E.g., -27.1% (mean deviation) of 0.008513931  (sd) --> -0.002307275
#    Let's subtract that deviation from w_i (ST.calibs.tweak)
#       0.01359319 - (-0.002307275) = 0.01590046
...
text( x = 100, y = 180,
      labels = expression( atop( ''*italic( R^2 )*' =  0.9999' ) ) )
text( x = 100, y = 175,
      labels = expression( atop( ''*italic( w )*' = '*italic( 0.997364 * t )*'' ) ) )
...
text( x = 100, y = 150,
      labels = expression( atop( ''*italic( R^2 )*' = 0.9997' ) ) )
text( x = 100, y = 145,
      labels = expression( atop( ''*italic( w )*' = '*italic(  1.002979 * t )*'' ) ) )
...
text( x = 110, y = 200,
      labels = expression( atop( ''*italic( R^2 )*' = 0.9998' ) ) )
text( x = 110, y = 195,
      labels = expression( atop( ''*italic( w )*' = '*italic(  1.036969 * t )*'' ) ) )

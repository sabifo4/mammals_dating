...
calibrations <- read.table( file = "Calibrations_LaurCetart_v2.txt",
...
write( x = phylip_header, file = paste( num_sp, "sp_lcetartiodactyla_MCMCtree_calib_v2.tree", sep = "" ) )
write( x = tree, file = paste( num_sp, "sp_lcetartiodactyla_MCMCtree_calib_v2.tree", sep = "" ),
       append = TRUE )

...
#
# Node 210:  ST ( 1.6419, 0.4248, 12.6518, 1714.5649 )
# Node 211:  ST ( 0.6064, 0.0046, 0.1781, 5.2201 )
# Node 213:  ST ( 0.4138, 0.0136, -0.1638, 18.2253 )
# Node 214:  ST ( 0.3562, 0.0137, 0.0215, 18.2141 )
# Node 216:  ST ( 0.3170, 0.0142, 0.2030, 19.2146 )
# Node 359:  ST ( 0.0858, 0.0099, 0.6707, 36.2204 )

# Node 211:  ST ( 1.6419, 0.4248, 12.6518, 1714.5649 )
# Node 212:  ST ( 0.6064, 0.0046, 0.1781, 5.2201 )
# Node 214:  ST ( 0.4138, 0.0136, -0.1638, 18.2253 )
# Node 215:  ST ( 0.3562, 0.0137, 0.0215, 18.2141 )
# Node 217:  ST ( 0.3170, 0.0142, 0.2030, 19.2146 )
# Node 360:  ST ( 0.0858, 0.0099, 0.6707, 36.2204 )
# Node 385:  ST ( 0.3236, 0.0160, -0.2546, 17.8353 )
...
text( x = 80, y = 178,
      labels = expression( atop( ''*italic( w )*' = '*italic( 0.995007  * t )*'' ) ) )
...
text( x = 80, y = 148,
      labels = expression( atop( ''*italic( w )*' = '*italic(  1.001052 * t )*'' ) ) )
...
text( x = 80, y = 195,
      labels = expression( atop( ''*italic( w )*' = '*italic( 1.034893 * t )*'' ) ) )

...
# Set name 
tname <- "Laurasiatheria_therest"

#=================#
# 2. SCAN TREES   #
#=================#
# Get trees 
tree_original <- readLines( con = "laurasiatheria_therest_rooted_calibnames.tree" )
tree <- tree_original

# Get sp names 
spnames <- ape::read.tree( "laurasiatheria_therest_rooted_calibnames.tree" )$tip.label

#======================================#
#    3. GET FILE WITH CALIBRATIONS 
#======================================#
# Read tree and rename cols
calibrations <- read.table( file = "laurasiathera_therest_calibrations.txt",
...
num_sp <- length( ape::read.tree( "laurasiatheria_therest_rooted_calibnames.tree" )$tip.label )

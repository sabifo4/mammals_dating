...
#=================#
# Get trees 
tree_original <- readLines( con = "lagomorpha_rooted_calibnames.tree" )
tree <- tree_original

# Get sp names 
spnames <- ape::read.tree( "lagomorpha_rooted_calibnames.tree" )$tip.label

#======================================#
#    3. GET FILE WITH CALIBRATIONS 
#======================================#
# Read tree and rename cols
calibrations <- read.table( file = "Calibrations_Lagomorpha.txt",
...
num_sp <- length( ape::read.tree( "lagomorpha_rooted_calibnames.tree" )$tip.label )

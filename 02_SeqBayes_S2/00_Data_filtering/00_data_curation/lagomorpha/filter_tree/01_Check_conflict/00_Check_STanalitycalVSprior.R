...
#
# Node  89:  ST ( 1.6419, 0.4248, 12.6518, 1714.5649 )
# Node  90:  ST ( 0.4744, 0.0079, 0.2934, 5.2736 )
...
text( x = 100, y = 175,
      labels = expression( atop( ''*italic( w )*' = '*italic( 0.993996 * t )*'' ) ) )
...
text( x = 100, y = 150,
      labels = expression( atop( ''*italic( R^2 )*' = 1 ' ) ) )
text( x = 100, y = 145,
      labels = expression( atop( ''*italic( w )*' = '*italic(  0.999441 * t )*'' ) ) )
...
text( x = 110, y = 195,
      labels = expression( atop( ''*italic( w )*' = '*italic(  1.037878 * t )*'' ) ) )

...
#=================#
# Get trees 
tree_original <- readLines( con = "euarchonta_rooted_calibnames.tree" )
tree <- tree_original

# Get sp names 
spnames <- ape::read.tree( "euarchonta_rooted_calibnames.tree" )$tip.label

#======================================#
#    3. GET FILE WITH CALIBRATIONS 
#======================================#
# Read tree and rename cols
calibrations <- read.table( file = "Calibrations_Euarchonta.txt",
...
num_sp <- length( ape::read.tree( "euarchonta_rooted_calibnames.tree" )$tip.label )

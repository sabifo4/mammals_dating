...
wd2 <- gsub( pattern = "00_data_curation..*", replacement = "",
             x = wd )
# Set name 
tname <- "Rodentia_squirrel"

#=================#
# 2. SCAN TREES   #
#=================#
# Get trees 
tree_original <- readLines( con = "rodentia_squirrel_rooted_calibnames.tree" )
tree <- tree_original

# Get sp names 
spnames <- ape::read.tree( "rodentia_squirrel_rooted_calibnames.tree" )$tip.label

#======================================#
#    3. GET FILE WITH CALIBRATIONS 
#======================================#
# Read tree and rename cols
calibrations <- read.table( file = "Calibrations_squirrel.txt",
...
num_sp <- length( ape::read.tree( "rodentia_squirrel_rooted_calibnames.tree" )$tip.label )

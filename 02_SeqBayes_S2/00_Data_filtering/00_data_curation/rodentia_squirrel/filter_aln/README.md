...
Within the [`filter_aln`](/02_SeqBayes_S2/00_Data_filtering/00_data_curation/rodentia_squirrel/filter_aln)
directory, you will find different files as detailed above. 
Specifically, the R script [`parse_lineage.R`](02_SeqBayes_S2/00_Data_filtering/00_data_curation/rodentia_squirrel/filter_aln/parse_lineage.R)
...
[`taxonomical_check`](/02_SeqBayes_S2/00_Data_filtering/00_data_curation/rodentia_squirrel/filter_aln/checked_aln/taxonomical_check)

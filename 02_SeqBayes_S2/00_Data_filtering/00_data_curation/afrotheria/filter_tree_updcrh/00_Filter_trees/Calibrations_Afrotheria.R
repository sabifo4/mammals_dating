...
#=================#
# Get trees 
tree_original <- readLines( con = "afrotheria_rooted_calibnames.tree" )
tree <- tree_original

# Get sp names 
spnames <- ape::read.tree( "afrotheria_rooted_calibnames.tree" )$tip.label

#======================================#
#    3. GET FILE WITH CALIBRATIONS     #
#======================================#
# Read tree and rename cols
calibrations <- read.table( file = "Calibrations_Afrotheria.txt",
...
num_sp <- length( ape::read.tree( "afrotheria_rooted_calibnames.tree" )$tip.label )

...
#=================#
# Get trees 
tree_original <- readLines( con = "laurasiatheria_chiropteraI_calibnames.tree" )
tree <- tree_original

# Get sp names 
spnames <- ape::read.tree( "laurasiatheria_chiropteraI_calibnames.tree" )$tip.label
...
num_sp <- length( ape::read.tree( "laurasiatheria_chiropteraI_calibnames.tree" )$tip.label )

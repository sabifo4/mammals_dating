...
#=================#
# Get trees 
tree_original <- readLines( con = "laurasiatheria_chiroptera_calibnames.tree" )
tree <- tree_original

# Get sp names 
spnames <- ape::read.tree( "laurasiatheria_chiroptera_calibnames.tree" )$tip.label
...
num_sp <- length( ape::read.tree( "laurasiatheria_chiroptera_calibnames.tree" )$tip.label )

...
[here](https://www.dropbox.com/s/qi2lvst5r61xaty/SeqBayesS2_filtaln_xenarthra.zip?dl=0).
...
In this case (xenarthra), we did not have to adjust any calibration as there were no
...
Calibrations used:   
   ...
   * Cingulata: B(0.3485,0.56)   
   * Chlamyphoridae: B(0.339,0.56)   
   * Pilosa: B(0.3117,0.56)   
   * Folivora: B(0.1599,0.56)   

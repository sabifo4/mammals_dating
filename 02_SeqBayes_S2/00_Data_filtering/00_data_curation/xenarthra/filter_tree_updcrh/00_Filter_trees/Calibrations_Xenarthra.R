...
#=================#
# Get trees 
tree_original <- readLines( con = "xenarthra_rooted_calibnames.tree" )
tree <- tree_original

# Get sp names 
spnames <- ape::read.tree( "xenarthra_rooted_calibnames.tree" )$tip.label

#======================================#
#    3. GET FILE WITH CALIBRATIONS 
#======================================#
# Read tree and rename cols
calibrations <- read.table( file = "Calibrations_Xenarthra.txt",
...
num_sp <- length( ape::read.tree( "xenarthra_rooted_calibnames.tree" )$tip.label )

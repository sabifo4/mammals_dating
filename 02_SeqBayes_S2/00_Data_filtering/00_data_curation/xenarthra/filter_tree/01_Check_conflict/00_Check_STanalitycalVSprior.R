...
#
# Node  34:  ST ( 1.6419, 0.4248, 12.6518, 1714.5649 )
# Node  35:  ST ( 0.6281, 0.0194, -0.3891, 4.8802 )
...
text( x = 100, y = 177,
      labels = expression( atop( ''*italic( w )*' = '*italic( 0.994916  * t )*'' ) ) )
...
text( x = 100, y = 148,
      labels = expression( atop( ''*italic( w )*' = '*italic(  0.999797 * t )*'' ) ) )
...
text( x = 110, y = 195,
      labels = expression( atop( ''*italic( w )*' = '*italic(  1.04159 * t )*'' ) ) )

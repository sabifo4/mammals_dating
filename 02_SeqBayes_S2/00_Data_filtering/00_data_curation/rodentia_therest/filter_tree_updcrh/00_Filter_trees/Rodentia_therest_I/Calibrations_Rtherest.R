...
#=================#
# Get trees 
tree_original <- readLines( con = "rodentia_therestI_rooted_calibnames.tree" )
tree <- tree_original

# Get sp names 
spnames <- ape::read.tree( "rodentia_therestI_rooted_calibnames.tree" )$tip.label
...
num_sp <- length( ape::read.tree( "rodentia_therestI_rooted_calibnames.tree" )$tip.label )

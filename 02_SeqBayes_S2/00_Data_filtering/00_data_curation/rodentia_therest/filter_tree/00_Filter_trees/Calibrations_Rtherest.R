...
#=================#
# Get trees 
tree_original <- readLines( con = "rodentia_therest_rooted_calibnames.tree" )
tree <- tree_original

# Get sp names 
spnames <- ape::read.tree( "rodentia_therest_rooted_calibnames.tree" )$tip.label
...
num_sp <- length( ape::read.tree( "rodentia_therest_rooted_calibnames.tree" )$tip.label )

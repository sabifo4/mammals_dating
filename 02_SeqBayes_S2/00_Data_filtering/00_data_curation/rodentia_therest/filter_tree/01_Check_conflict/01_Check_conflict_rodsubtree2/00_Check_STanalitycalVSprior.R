...
#
# Node 692:  ST ( 1.6419, 0.4248, 12.6518, 1714.5649 )
# Node 693:  ST ( 0.1744, 0.0351, 3.1168, 381.9704 )
# Node 698:  ST ( 0.0889, 0.0241, 3.7938, 547.4454 )
# Node 752:  ST ( 0.0432, 0.0128, 3.5750, 94.2223 )
# Node 770:  ST ( 0.0222, 0.0068, 3.4256, 86.2455 )
# Node 771:  ST ( 0.0104, 0.0033, 3.3802, 83.5293 )
# Node 1379:  ST ( 0.1366, 0.0302, 3.4638, 240.3174 )
...
text( x = 100, y = 175,
      labels = expression( atop( ''*italic( w )*' = '*italic( 0.994981 * t )*'' ) ) )
...
text( x = 100, y = 150,
      labels = expression( atop( ''*italic( R^2 )*' = 1' ) ) )
text( x = 100, y = 145,
      labels = expression( atop( ''*italic( w )*' = '*italic(  0.998894 * t )*'' ) ) )
...
text( x = 110, y = 200,
      labels = expression( atop( ''*italic( R^2 )*' = 1' ) ) )
text( x = 110, y = 195,
      labels = expression( atop( ''*italic( w )*' = '*italic(  1.042669 * t )*'' ) ) )
...
#
# A) E.g., 3.8% (mean deviation) of 10.762692 (My, x.mean) -->  0.4089823 
#    Let's subtract that deviation from x_i after dividing into 100
#       0.0889 - (0.004089823) = 0.08481018
#===================================================================================================#
...
#
# A) E.g., 19% (mean deviation) of 0.01517994    (sd ) --> 0.002884189
#    Let's subtract that deviation from w_i
#       0.0241 - (0.002884189) = 0.02121581
#
dub.pos         <- c(3,6)
...
rownames( tmp.tab ) <- names( add.to.STwi )
for( i in dub.pos ){
...
text( x = 100, y = 180,
      labels = expression( atop( ''*italic( R^2 )*' =  1' ) ) )
text( x = 100, y = 175,
      labels = expression( atop( ''*italic( w )*' = '*italic( 0.994215 * t )*'' ) ) )
...
text( x = 100, y = 150,
      labels = expression( atop( ''*italic( R^2 )*' = 1' ) ) )
text( x = 100, y = 145,
      labels = expression( atop( ''*italic( w )*' = '*italic(  1.000232 * t )*'' ) ) )
...
text( x = 110, y = 200,
      labels = expression( atop( ''*italic( R^2 )*' = 1' ) ) )
text( x = 110, y = 195,
      labels = expression( atop( ''*italic( w )*' = '*italic(  1.041368 * t )*'' ) ) )

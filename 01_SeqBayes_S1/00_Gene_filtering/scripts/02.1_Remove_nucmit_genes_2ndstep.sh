...
# ===================================================================== #
# This script goes through each directory in the `filtered_genes_step2` #
# directory and finds out which of these genes have also been include   #
# in the data set that is to be analysed in the second step of this     #
# sequential Bayesian dating analysis.                                  #
#                                                                       #
...
# and move to `filtered_genes_step2`
curr_dir=$( pwd )
cd $curr_dir/filtered_genes_step2

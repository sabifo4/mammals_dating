...
# 1. Load trees and mcmc files for master tree: 07_afrotheria_tarver2016 
## GBM - posterior
...
for( i in seq(1:length( phy.post.GBM ) ) ){
        ...
        phy.post.GBM[[ i ]] <-  MCMCtreeR::readMCMCtree( paste( wd_trees, "00_MCMCtree/mcmc",
                                                           i, "/mcmctree_GBM/07_afrotheria_tarver2016/FigTree.tre", sep = "" ),
                                                    from.file = TRUE )
        mcmc.post.GBM[[ i ]] <- read.table( paste( wd_trees, "00_MCMCtree/mcmc",
                                                  i, "/mcmctree_GBM/07_afrotheria_tarver2016/mcmc.txt", sep = "" ),
...
abline( v = 177.5, col = "black", lty = 2 )

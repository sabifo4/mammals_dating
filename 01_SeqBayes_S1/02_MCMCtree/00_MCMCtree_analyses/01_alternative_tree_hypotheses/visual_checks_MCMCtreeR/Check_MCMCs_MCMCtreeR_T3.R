...
# 1. Load trees and mcmc files for master tree: 03_atlantogenata_tarver2016_laurasiatheria_dosReis2012 
## GBM - posterior
...
for( i in seq(1:length( phy.post.GBM ) ) ){
        ...
        phy.post.GBM[[ i ]] <-  MCMCtreeR::readMCMCtree( paste( wd_trees, "00_MCMCtree/mcmc",
                                                           i, "/mcmctree_GBM/03_atlantogenata_tarver2016_laurasiatheria_dR2012/FigTree.tre", sep = "" ),
                                                    from.file = TRUE )
        mcmc.post.GBM[[ i ]] <- read.table( paste( wd_trees, "00_MCMCtree/mcmc",
                                                  i, "/mcmctree_GBM/03_atlantogenata_tarver2016_laurasiatheria_dR2012/mcmc.txt", sep = "" ),
...
abline( v = 177.8, col = "black", lty = 2 )
